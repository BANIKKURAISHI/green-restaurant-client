...
const Footer = () => {
  ...
  <nav >
    ...
    <a className="link link-hover">Change logs</a>
  </nav>
  <nav > 
    ...
    <a className="link link-hover">Revenue Detection</a>
  </nav>
  <nav className=''>
...
<footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-4 ">
  <aside className="grid-flow-col items-center ml-5">
    <svg
      width="36"
      height="36"
      viewBox="0 0 24 24"
  ...
  <nav className="grid-flow-col ml-6 gap-4 md:place-self-end  lg:justify-self-end mr-24">
